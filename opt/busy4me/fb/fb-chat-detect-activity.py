...
list = [img_path+'cross_chat.png', img_path+'cross_chat2.png', img_path+'cross_chat3.png', img_path+'chat_icon.png']
...
def click_chat_icon ():
    ...
    if chat_icon != None:
        ...
        print "found %r ... nobody chatting ... exit" % imag
        print chat_icon_x, chat_icon_y
        sys.stdout.write("\033[1;0m")
        pyautogui.moveTo(chat_icon_x, chat_icon_y, 0.1, pyautogui.easeOutQuad)
        pyautogui.moveTo(chat_icon_x-50, chat_icon_y+20, 0.3, pyautogui.easeOutQuad)
        pyautogui.moveTo(chat_icon_x+50, chat_icon_y, 0.3, pyautogui.easeOutQuad)
...
def close_chat_window ():
    ...
    while count < 3:
        ...
        if cross is None:
            ...
            pyautogui.moveTo(cross_x, cross_y, r*0.1, pyautogui.easeInElastic)
            pyautogui.moveTo(cross_x-180+(r*10), cross_y+5, r2*0.1, pyautogui.easeInElastic)
            pyautogui.moveTo(cross_x-140+(r*10), cross_y, r3*0.1, pyautogui.easeInElastic)
            pyautogui.moveTo(cross_x-160, cross_y, r*0.1, pyautogui.easeInElastic)
