...
pyautogui.moveTo(160, 38, 1, pyautogui.easeOutQuad)
...
pyautogui.moveTo(160, 28, 1, pyautogui.easeOutQuad)
pyautogui.moveTo(180, 500, 4, pyautogui.easeOutQuad)
pyautogui.moveTo(160, 80, 2, pyautogui.easeOutQuad)
pyautogui.moveTo(190, 480, 2, pyautogui.easeOutQuad)
pyautogui.moveTo(170, 40, 1, pyautogui.easeOutQuad)
pyautogui.moveTo(200, 380, 2, pyautogui.easeOutQuad)
circle_03()
pyautogui.moveTo(500, 400, 0.3, pyautogui.easeOutQuad)
circle_01()
pyautogui.moveTo(280, 100, 0.5, pyautogui.easeOutQuad)
...
pyautogui.moveTo(420, 400, 0.7, pyautogui.easeOutQuad)
circle_01()
pyautogui.moveTo(200, 38, 1, pyautogui.easeOutQuad)
pyautogui.moveTo(220, 500, 0.3, pyautogui.easeOutQuad)
pyautogui.moveTo(210, 28, 0.3, pyautogui.easeOutQuad)
pyautogui.moveTo(230, 500, 0.3, pyautogui.easeOutQuad)
...
circle_01()
pyautogui.moveTo(160, 38, 1, pyautogui.easeOutQuad)
pyautogui.moveTo(180, 500, 0.3, pyautogui.easeOutQuad)
pyautogui.moveTo(170, 28, 0.3, pyautogui.easeOutQuad)
pyautogui.moveTo(190, 500, 0.3, pyautogui.easeOutQuad)

t = random.randint(1,2)
x = random.randint(650,750)
y = random.randint(5,20)
pyautogui.moveTo(170, 38, t, pyautogui.easeOutQuad)
pyautogui.moveTo(x, y, 3, pyautogui.easeOutQuad)
pyautogui.moveTo(170, 48, t, pyautogui.easeOutQuad)
pyautogui.moveTo(650, y, t, pyautogui.easeOutQuad)
x = random.randint(220,320)
y = random.randint(160,30)
pyautogui.moveTo(x, y, 1, pyautogui.easeOutQuad)
pyautogui.moveTo(670, 25, 1, pyautogui.easeOutQuad)
x = random.randint(220,320)
y = random.randint(165,20)
pyautogui.moveTo(x, y, 0.3, pyautogui.easeOutQuad)
pyautogui.moveTo(690, 25, 0.3, pyautogui.easeOutQuad)

x = random.randint(155,30)
y = random.randint(155,30)
